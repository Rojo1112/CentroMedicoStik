...
public class Cita {
     ...
     * @param citasM       Motivo de la cita
    ...
    private void actualizarCostoCita() {
        if ("CONTROL".equals(citasM)) {
            costo = "Gratis";
        } else if ("VALORACION".equals(citasM)) {
            costo = "4500";
            if ("MEDICINA_GENERAL".equals(especialidad)) {
                costo = "2500";
            }
        } else if ("EXAMEN".equals(citasM)) {
            costo = "5000";
        }
    }
